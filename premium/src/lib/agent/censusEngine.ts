...
async function createInitialEvaluationContinuityReview(
  ...
  try {
    // El hallazgo queda esperando decisión docente en la bandeja. NO se le
    // publica nada a la estudiante: aunque "falta el plan" sea un hecho
    // verificable, el detector puede equivocarse, y un reclamo injusto que
    // nadie revisó cuesta más que el minuto que toma aprobarlo.
