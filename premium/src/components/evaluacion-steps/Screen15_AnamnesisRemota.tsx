                            ...
                            <div className="space-y-3">
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="flex flex-col">
                                        <select disabled={isClosed} value={c.estado || ''} onChange={e => updateDetalle(c.name, 'estado', e.target.value)} className="text-xs p-2 rounded-lg outline-none border border-slate-200 bg-white shadow-sm hover:border-rose-300 transition-colors cursor-pointer">
                                    ...
                                    <div className="flex items-center">
                                        <label className="flex items-center gap-2 text-[11px] font-medium text-slate-700 cursor-pointer w-full p-2 hover:bg-white rounded-lg transition-colors border border-transparent hover:border-slate-200">
                                            <input
                                ...
                                {c.tratamientoActual && (
                                    <div className="animate-in slide-in-from-top-2 duration-200">
                                        <input
                                            ...
                                            className="w-full text-xs p-2.5 rounded-lg border border-indigo-200 bg-indigo-50/50 outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 placeholder:text-slate-400 shadow-inner"
                                        />
                                    </div>
                                )}
                                ...
                                <div>
                                    <input
                                        ...
                                        className="w-full text-xs p-2.5 rounded-lg border border-slate-200 outline-none focus:border-rose-400 focus:ring-1 focus:ring-rose-400 bg-white placeholder:text-slate-400 shadow-sm"
                                    />
