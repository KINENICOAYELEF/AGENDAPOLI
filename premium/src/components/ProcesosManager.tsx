            ...
            {indexError && (
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-xl">
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <h3 className="text-sm border-b-0 font-medium text-red-800">Falta Índice Compuesto en Firestore</h3>
                            <div className="mt-1 text-sm text-red-700">
                                <p>Por favor, revisa la consola para crear el índice y vuelve a intentarlo.</p>
                            </div>
                        </div>
                    </div>
                </div>
