...
export function LegacyImporter() {
    ...
    const handleImport = async () => {
        ...
        const confirm = window.confirm(`Vas a importar data legacy en el universo ${targetYear}.\n\nRevisa el contador:\n- Usuarias: ${report.totalUsersDetected}\n- Episodios: ${report.totalEvolDetected}\n\nEsto consumirá tus cuotas de escritura de Firebase gratuitamente. ¿Comenzar inyección?`);
