                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                <div className="font-bold text-slate-900 group-hover:text-indigo-700 transition-colors">{u.identity?.fullName || (u as any).nombreCompleto}</div>
                                                <div className="text-xs text-slate-500 truncate max-w-[220px] mt-0.5">{u.identity?.observacionesAdministrativas || (u as any).notasAdministrativas || 'Sin observaciones base'}</div>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4">
                                                {isMyPatient ? (
                                                    <span className="inline-flex items-center gap-1 bg-indigo-50 text-indigo-700 border border-indigo-200 font-extrabold text-xs px-2.5 py-1 rounded-lg">
                                                        <span>👤</span> Mi Paciente
                                                    </span>
                                                ) : u.meta?.assignedInternName ? (
                                            ...
                                            <td className="px-6 py-4 text-right" onClick={(e) => e.stopPropagation()}>
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        onClick={() => { setSelectedUser(u); setInitialAction('EVOLUCIONAR'); setIsFormOpen(true); }}
                                                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-3 py-1.5 rounded-lg shadow-xs transition flex items-center gap-1"
                                                    ...
                                                    <button
                                                        onClick={() => { setSelectedUser(u); setIsFormOpen(true); }}
                                                        className="text-slate-700 hover:text-indigo-700 font-semibold text-xs bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-lg transition border border-slate-200"
                                                    >
                                                        Expediente
                                                    </button>
                                                    {canDelete && (
