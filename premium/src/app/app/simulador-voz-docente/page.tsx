...
import { SimuladorExamenVozDocente } from '@/components/SimuladorExamenVozDocente';

export default function SimuladorVozDocentePage() {
    ...
    return <SimuladorExamenVozDocente />;
}
