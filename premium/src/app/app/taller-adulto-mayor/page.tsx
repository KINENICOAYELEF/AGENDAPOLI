    ...
    <div className="mx-auto max-w-7xl pb-20">
      <section className="relative overflow-hidden rounded-[30px] bg-[linear-gradient(125deg,#052e2b_0%,#065f55_55%,#0f766e_100%)] px-5 py-6 text-white shadow-xl shadow-teal-950/10 sm:px-8 sm:py-8">
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div><div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[.18em]"><Activity className="h-3.5 w-3.5" /> Taller de Adulto Mayor</div><h1 className="max-w-2xl text-3xl font-black tracking-tight sm:text-4xl">El taller completo, sin papeleo innecesario.</h1><p className="mt-2 max-w-2xl text-sm font-medium leading-relaxed text-teal-50/80">Asistencia rápida, evaluación funcional, reevaluaciones cada 4–6 semanas y registro grupal por voz.</p></div>
