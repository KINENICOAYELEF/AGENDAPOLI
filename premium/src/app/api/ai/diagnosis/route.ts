...
export async function POST(req: Request) {
  ...
  "clasificacion_dolor": { "opciones_categoria": [], "categoria_seleccionada": "", "opciones_subtipo_apellido": [], "subtipo_seleccionado": "", "fundamento_breve": "", "nivel_confianza": "Alta|Media|Baja" },
