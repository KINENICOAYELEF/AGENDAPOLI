...
import { getFirestore, collection, addDoc, getDocs, doc, getDoc, updateDoc, query, orderBy, serverTimestamp, deleteDoc, setDoc } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";
...
// Códigos CIF relevantes para kinesiología musculoesquelética y deportiva
const cifCodesMusculoskeletal = {
    funciones: [
        ...
        { code: 'b715', name: 'Funciones de estabilidad articular', desc: 'Funciones relacionadas con el mantenimiento de la integridad estructural de las articulaciones.' },
        { code: 'b720', name: 'Funciones de movilidad ósea', desc: 'Funciones relacionadas con el rango y facilidad de movimiento de la escápula, pelvis, huesos carpianos y tarsianos.' },
        ...
        { code: 'b735', name: 'Funciones de tono muscular', desc: 'Funciones relacionadas con la tensión presente en los músculos cuando están en reposo y la resistencia que ofrecen al intentar moverlos pasivamente.' },
        ...
        { code: 'b750', name: 'Funciones relacionadas con reflejos motores', desc: 'Funciones de contracción involuntaria de los músculos, inducida automáticamente por estímulos específicos.' },
        { code: 'b755', name: 'Funciones relacionadas con reacciones al movimiento involuntario', desc: 'Reacciones posturales, de equilibrio y de apoyo involuntarias causadas por la posición corporal o el movimiento.' },
        { code: 'b760', name: 'Funciones relacionadas con el control del movimiento voluntario', desc: 'Funciones asociadas con el control y coordinación del movimiento voluntario.' },
        { code: 'b765', name: 'Funciones relacionadas con movimientos involuntarios', desc: 'Contracciones no intencionales, involuntarias de los músculos o grupos de músculos.' },
        { code: 'b770', name: 'Funciones relacionadas con el patrón de marcha', desc: 'Funciones relacionadas con los patrones de movimiento al caminar, correr u otros movimientos de todo el cuerpo.' },
        { code: 'b780', name: 'Sensaciones relacionadas con los músculos y funciones del movimiento', desc: 'Sensaciones asociadas con los músculos o grupos de músculos del cuerpo y su movimiento.' }
    ],
    estructuras: [
        { code: 's710', name: 'Estructura de la región de la cabeza y cuello', desc: 'Huesos, músculos y otros tejidos de la cabeza y región cervical.' },
        { code: 's720', name: 'Estructura de la región del hombro', desc: 'Huesos, articulaciones, músculos, ligamentos y fascias de la región del hombro.' },
        { code: 's730', name: 'Estructura de la extremidad superior', desc: 'Huesos, articulaciones, músculos y otros tejidos del brazo, antebrazo y mano.' },
        { code: 's740', name: 'Estructura de la región pélvica', desc: 'Huesos, músculos y otros tejidos de la región pélvica.' },
        { code: 's750', name: 'Estructura de la extremidad inferior', desc: 'Huesos, articulaciones, músculos y otros tejidos de la pierna y el pie.' },
        { code: 's760', name: 'Estructura del tronco', desc: 'Huesos, articulaciones, músculos y otros tejidos de la columna vertebral, costillas y parte superior de la espalda.' },
        { code: 's770', name: 'Estructuras musculoesqueléticas adicionales relacionadas con el movimiento', desc: 'Huesos, articulaciones, músculos, ligamentos y fascias adicionales relacionados con el movimiento.' }
    ],
    actividades: [
        ...
        { code: 'd415', name: 'Mantener la posición del cuerpo', desc: 'Mantener el cuerpo en la misma posición durante el tiempo necesario, como permanecer sentado o de pie en el trabajo o en la escuela.' },
        ...
        { code: 'd430', name: 'Levantar y llevar objetos', desc: 'Levantar un objeto o llevar algo de un sitio a otro, como levantar una taza o llevar a un niño de una habitación a otra.' },
        { code: 'd435', name: 'Mover objetos con las extremidades inferiores', desc: 'Realizar las acciones coordinadas necesarias para mover objetos con las piernas y los pies, como dar patadas a un balón o pedalear en una bicicleta.' },
        { code: 'd440', name: 'Uso fino de la mano', desc: 'Realizar las acciones coordinadas de manejo de objetos, recogerlos, manipularlos y soltarlos utilizando la mano, los dedos y el pulgar.' },
        ...
        { code: 'd450', name: 'Caminar', desc: 'Andar sobre una superficie a pie, paso a paso, de manera que al menos un pie esté siempre en el suelo.' },
        { code: 'd455', name: 'Desplazarse por el entorno', desc: 'Mover todo el cuerpo de un sitio a otro sin caminar, como escalar una roca o correr por una calle, saltar, etc.' },
        { code: 'd460', name: 'Desplazarse por distintos lugares', desc: 'Caminar y moverse por diversos lugares y situaciones, como andar entre habitaciones, dentro de un edificio o por la calle.' },
        { code: 'd465', name: 'Desplazarse utilizando algún tipo de equipamiento', desc: 'Mover todo el cuerpo de un lugar a otro, sobre cualquier superficie o espacio, utilizando dispositivos específicos.' },
        { code: 'd470', name: 'Utilización de medios de transporte', desc: 'Utilizar medios de transporte para desplazarse como pasajero, como ser llevado en un coche, autobús, etc.' }
    ],
    factores: [
        ...
        { code: 'e115', name: 'Productos y tecnología para uso personal en la vida diaria', desc: 'Equipamiento, productos y tecnologías utilizados por las personas en las actividades cotidianas.' },
        { code: 'e120', name: 'Productos y tecnología para la movilidad y el transporte personal en espacios cerrados y abiertos', desc: 'Equipamiento, productos y tecnologías utilizados por las personas para desplazarse dentro y fuera de edificios.' },
        { code: 'e135', name: 'Productos y tecnología para el empleo', desc: 'Equipamiento, productos y tecnologías utilizados para el empleo, para facilitar las actividades laborales.' },
        { code: 'e140', name: 'Productos y tecnología para las actividades culturales, recreativas y deportivas', desc: 'Equipamiento, productos y tecnologías utilizados para la realización y mejora de las actividades culturales, recreativas y deportivas.' },
        { code: 'e150', name: 'Diseño, construcción, materiales de construcción y tecnología arquitectónica para edificios de uso público', desc: 'Productos y tecnología que constituyen el ambiente fabricado por el hombre y que ha sido planeado, diseñado y construido para uso público.' },
        { code: 'e155', name: 'Diseño, construcción, materiales de construcción y tecnología arquitectónica para edificios de uso privado', desc: 'Productos y tecnología que constituyen el ambiente fabricado por el hombre y que ha sido planeado, diseñado y construido para uso privado.' }
    ]
};
...
function setupCifCategories(patientId) {
    try {
        ...
        setupCifCategory('addCifFunctionBtn', 'cifFunctions', 'Función', [], patientId);
        setupCifCategory('addCifStructureBtn', 'cifStructures', 'Estructura', [], patientId);
        setupCifCategory('addCifActivityBtn', 'cifActivities', 'Actividad', [], patientId);
        setupCifCategory('addCifFactorBtn', 'cifFactors', 'Factor', [], patientId);
        
        // Cargar factores personales
        const personalFactorsField = document.getElementById('cifPersonalFactors');
        if (personalFactorsField) {
            // No hacemos nada aquí ya que loadCifData se encarga de llenar este campo
        }
    } catch (error) {
        console.error("Error en setupCifCategories:", error);
        showToast("Error al configurar categorías CIF", "error");
    }
}

// Configurar una categoría CIF específica
function setupCifCategory(buttonId, containerId, categoryType, items, patientId) {
...
function renderCifItems(container, items) {
    ...
    items.forEach(item => {
        ...
        itemElement.dataset.id = item.id || 'cif_' + Date.now();
        
        // Valor predeterminado si no existe
        const value = item.value !== undefined ? item.value : 2;
        ...
        itemElement.querySelectorAll('.scale-values .scale-value').forEach(button => {
...
function showCifSelectorModal(categoryType, targetContainerId, patientId) {
    ...
    if (searchInput) {
        ...
        if (resultsContainer) {
            ...
            // Añadir lista predefinida según categoría
            let cifCodes = [];
            switch(categoryType) {
                case 'Función':
                    cifCodes = cifCodesMusculoskeletal.funciones;
                    break;
                case 'Estructura':
                    cifCodes = cifCodesMusculoskeletal.estructuras;
                    break;
                case 'Actividad':
                    cifCodes = cifCodesMusculoskeletal.actividades;
                    break;
                case 'Factor':
                    cifCodes = cifCodesMusculoskeletal.factores;
                    break;
                default:
                    cifCodes = [];
            }
            
            // Mostrar toda la lista al principio
            const fragment = document.createDocumentFragment();
            cifCodes.forEach(result => {
        ...
        newSearchInput.addEventListener('input', function() {
            ...
            // Filtrar resultados
            let results = cifCodes;
            if (searchTerm.length > 0) {
                results = cifCodes.filter(item => 
...
function addCifItem(modal) {
    try {
        ...
        if (!container) {
            showToast("Error: Contenedor no encontrado", "error");
            return;
        }
        ...
        // Añadir interactividad a los botones de escala
        newItem.querySelectorAll('.scale-values .scale-value').forEach(button => {
            button.addEventListener('click', function() {
                // Desactivar otros botones del mismo grupo
                const scaleValues = this.closest('.scale-values');
                if (scaleValues) {
        ...
        setTimeout(() => {
            ...
            // Guardar cambios en Firebase si hay un ID de paciente válido
            if (patientId) {
                saveCifData(patientId).catch(error => {
                    console.error("Error al guardar cambios CIF:", error);
                });
            }
        }, 300);
    } catch (error) {
        console.error("Error al añadir elemento CIF:", error);
        showToast("Error al añadir elemento CIF: " + error.message, "error");
    }
}


        // Función para guardar los datos CIF de un paciente
async function saveCifData(patientId) {
    try {
        showLoading();
        
        // Recopilar datos de CIF desde el DOM
        const cifData = {
            functions: getCifItemsData('cifFunctions'),
            structures: getCifItemsData('cifStructures'),
            activities: getCifItemsData('cifActivities'),
            factors: getCifItemsData('cifFactors'),
            personalFactors: document.getElementById('cifPersonalFactors')?.value || ""
        };
        
        console.log("Guardando datos CIF:", cifData);
        
        // Guardar en Firebase
        const cifRef = doc(db, "patients", patientId, "cif", "data");
        await setDoc(cifRef, cifData);
        
        hideLoading();
        showToast("Datos CIF guardados correctamente", "success");
        return true;
    } catch (error) {
        console.error("Error guardando datos CIF:", error);
        hideLoading();
        showToast("Error al guardar datos CIF: " + error.message, "error");
        return false;
    }
}

// Función auxiliar para obtener datos de elementos CIF
function getCifItemsData(containerId) {
    const container = document.getElementById(containerId);
    if (!container) return [];
    
    const items = [];
    const cifItems = container.querySelectorAll('.cif-item');
    
    cifItems.forEach(item => {
        const codeElement = item.querySelector('.cif-code');
        const descElement = item.querySelector('.cif-desc');
        const activeValueElement = item.querySelector('.cif-code .scale-value') || 
                                  item.querySelector('.scale-values .scale-value.active');
        
        if (codeElement) {
            const codeText = codeElement.textContent.trim();
            // Extraer código y nombre (formato típico: "b280: Sensación de dolor")
            const colonIndex = codeText.indexOf(':');
            const code = colonIndex > 0 ? codeText.substring(0, colonIndex).trim() : codeText;
            const name = colonIndex > 0 ? codeText.substring(colonIndex + 1).trim() : '';
            
            // Extraer valor del calificador
            const value = activeValueElement ? parseInt(activeValueElement.textContent.trim()) : 0;
            
            // Extraer descripción
            const description = descElement ? descElement.textContent.trim() : '';
            
            items.push({
                id: item.dataset.id || 'cif_' + Date.now() + '_' + Math.floor(Math.random() * 1000),
                code: code,
                name: name,
...
// Nueva función para cargar datos CIF
async function loadCifData(patientId) {
    try {
        // Intentar obtener datos CIF de Firebase
        const cifRef = doc(db, "patients", patientId, "cif", "data");
        const cifDoc = await getDoc(cifRef);
        
        if (cifDoc.exists()) {
            const cifData = cifDoc.data();
            console.log("Datos CIF cargados:", cifData);
            
            // Cargar funciones
            if (cifData.functions && cifData.functions.length > 0) {
                renderCifItems(document.getElementById('cifFunctions'), cifData.functions);
            } else {
                renderCifItems(document.getElementById('cifFunctions'), []);
            }
            
            // Cargar estructuras
            if (cifData.structures && cifData.structures.length > 0) {
                renderCifItems(document.getElementById('cifStructures'), cifData.structures);
            } else {
                renderCifItems(document.getElementById('cifStructures'), []);
            }
            
            // Cargar actividades
            if (cifData.activities && cifData.activities.length > 0) {
                renderCifItems(document.getElementById('cifActivities'), cifData.activities);
            } else {
                renderCifItems(document.getElementById('cifActivities'), []);
            }
            
            // Cargar factores
            if (cifData.factors && cifData.factors.length > 0) {
                renderCifItems(document.getElementById('cifFactors'), cifData.factors);
            } else {
                renderCifItems(document.getElementById('cifFactors'), []);
            }
            
            // Cargar factores personales
            const personalFactorsField = document.getElementById('cifPersonalFactors');
            if (personalFactorsField && cifData.personalFactors) {
                personalFactorsField.value = cifData.personalFactors;
            }
        } else {
            // No hay datos CIF, inicializar con valores vacíos
            renderCifItems(document.getElementById('cifFunctions'), []);
            renderCifItems(document.getElementById('cifStructures'), []);
            renderCifItems(document.getElementById('cifActivities'), []);
            renderCifItems(document.getElementById('cifFactors'), []);
        ...
        console.error("Error cargando datos CIF:", error);
        // No mostrar toast para no confundir al usuario
    }
}
...
async function saveDiagnosisChanges(patientId) {
    try {
        ...
        // Guardar datos CIF
        const result = await saveCifData(patientId);
