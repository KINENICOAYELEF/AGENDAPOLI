...
function setupCifCategories(patientId) {
    try {
        ...
        setupCifCategory('addCifFunctionBtn', 'cifFunctions', 'Función', []);
        setupCifCategory('addCifStructureBtn', 'cifStructures', 'Estructura', []);
        setupCifCategory('addCifActivityBtn', 'cifActivities', 'Actividad', []);
        setupCifCategory('addCifFactorBtn', 'cifFactors', 'Factor', []);
...
function getCifItemsData(containerId) {
    ...
    cifItems.forEach(item => {
        ...
        if (codeElement) {
            ...
            const name = colonIndex > 0 ? codeText.substring(colonIndex + 1, codeText.indexOf('0') || codeText.indexOf('1') || codeText.indexOf('2') || codeText.indexOf('3') || codeText.indexOf('4') || codeText.length).trim() : '';
